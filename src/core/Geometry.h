...
public:
	...
	Triangle(const Vec3f& a, const Vec3f& b, const Vec3f& c, const Vec3f& an, const Vec3f& bn, const Vec3f& cn) {
		positions = std::array<Vec3f, 3>{ a, b, c };
		normals = std::array<Vec3f, 3>{an, bn, cn};
	}
	Triangle(const Vec3f& a, const Vec3f& b, const Vec3f& c, const Vec2f& at, const Vec2f& bt, const Vec2f& ct) {
		positions = std::array<Vec3f, 3>{ a, b, c };
		tex_coords = std::array<Vec2f, 3>{at, bt, ct};
	}
	Triangle(const Vec3f& a, const Vec3f& b, const Vec3f& c, const Vec3f& an, const Vec3f& bn, const Vec3f& cn, const Vec2f& at, const Vec2f& bt, const Vec2f& ct) {
		positions = std::array<Vec3f, 3>{ a, b, c };
		normals = std::array<Vec3f, 3>{ an, bn, cn };
		tex_coords = std::array<Vec2f, 3>{ at, bt, ct };
	}
	...
	Vec3f get_normal(const Vec3f& position) override {
		// based on face_normals, either interpolate vn's or compute the (constant) normal manually
...
public:
	...
	Quad(const Vec3f& a, const Vec3f& b, const Vec3f& c, const Vec3f& d, const Vec3f& an, const Vec3f& bn, const Vec3f& cn, const Vec3f& dn) {
		positions = std::array<Vec3f, 4>{ a, b, c, d };
		normals = std::array<Vec3f, 4>{ an, bn, cn, dn };
	}
	Quad(const Vec3f& a, const Vec3f& b, const Vec3f& c, const Vec3f& d, const Vec2f& at, const Vec2f& bt, const Vec2f& ct, const Vec2f& dt) {
		positions = std::array<Vec3f, 4>{ a, b, c, d };
		tex_coords = std::array<Vec2f, 4>{ at, bt, ct, dt };
	}
	Quad(const Vec3f& a, const Vec3f& b, const Vec3f& c, const Vec3f& d, const Vec3f& an, const Vec3f& bn, const Vec3f& cn, const Vec3f& dn, const Vec2f& at, const Vec2f& bt, const Vec2f& ct, const Vec2f& dt) {
		positions = std::array<Vec3f, 4>{ a, b, c, d };
		normals = std::array<Vec3f, 4>{ an, bn, cn, dn };
		tex_coords = std::array<Vec2f, 4>{ at, bt, ct, dt };
	}
